...
|:---------|:--------------------|:--------------|:---------------------|
| 6.12.55  | armv7-fpga          | 1             | [6.12.55-armv7-fpga-1](https://github.com/ikwzm/FPGA-SoC-Linux-Kernel-6.12/tree/6.12.55-armv7-fpga-1) |

Download
------------------------------------------------------------------------------------

```console
shell$ export RELEASE_TAG=6.12.55-armv7-fpga-1
