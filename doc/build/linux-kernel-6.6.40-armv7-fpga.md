...
```console
shell$ git tag -a v6.12.55-armv7-fpga -m "release v6.12.55-armv7-fpga-1"
...
```console
shell$ cp arch/arm/boot/zImage ../vmlinuz-6.12.55-armv7-fpga-1
shell$ install -d              ../files
shell$ cp .config              ../files/config-6.12.55-armv7-fpga-1
```

#### Install devicetree to this repository

```console
shell$ install -d                           ../devicetrees/6.12.55-armv7-fpga-1
shell$ cp arch/arm/boot/dts/xilinx/*        ../devicetrees/6.12.55-armv7-fpga-1
shell$ cp arch/arm/boot/dts/intel/socfpga/* ../devicetrees/6.12.55-armv7-fpga-1
```
